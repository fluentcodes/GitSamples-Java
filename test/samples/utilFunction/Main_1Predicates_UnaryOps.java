...
public class Main_1Predicates_UnaryOps {
    public static void main(String[] args) {
        ...
        System.out.println("Is adult? "+isAdult.test(new Person(17,true)));
        System.out.println("Is male? "+isMale.test(new Person(1,true)));
        ...
        System.out.println("allowedToCryInPublic? "+allowedToCryInPublic.test(new Person(35,true)));    //Kerl
        System.out.println("allowedToCryInPublic? "+allowedToCryInPublic.test(new Person(15,true)));    //Junge
        System.out.println("allowedToCryInPublic? "+allowedToCryInPublic.test(new Person(58,false)));   //Reife Dame

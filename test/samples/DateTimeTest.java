...
public class DateTimeTest {
    ...
    public void testZoneDateTimeGaps() throws Exception {
        ...
        IntStream.rangeClosed(-2, 2).mapToObj(gap::plusHours).forEach(DateTimeTest::zonedAndLocal);

        System.out.println("Winterzeit-Umstellung");
        final ZonedDateTime overlap = ZonedDateTime.of(2014, 10, 26, 2, 30, 0, 0, zoneIdBerlin);
        IntStream.rangeClosed(-2, 2).mapToObj(overlap::plusHours).forEach(DateTimeTest::zonedAndLocal);
    }
